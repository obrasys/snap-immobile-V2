...
export function CameraControls({
  ...
  const isHdrDisabled = !supportsExposureCompensation;
  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        ...
        >
          <Icons.Grid className="w-6 h-6" style={uiRotateStyle} />
        </button>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            ...
            disabled={isDisabled || isHdrDisabled}
            className={`text-white/40 hover:text-white p-2 ${isHdrDisabled ? "opacity-30 cursor-not-allowed" : ""}`}
          >
            {captureMode === "single" ? (
              <Icons.Camera className="w-7 h-7" style={uiRotateStyle} />
            ) : (
              <Icons.Aperture className="w-7 h-7" style={uiRotateStyle} />
            )}
          </button>
          ...
          >
            <Icons.X className="w-7 h-7" style={uiRotateStyle} />
          </button>
        </div>
      </div>
    </div>
